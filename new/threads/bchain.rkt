...
(define (calculate-hash index prev-hash timestamp data)
  (sha1 (bytes-append
         (string->bytes/utf-8 (number->string index))
         prev-hash
...
(define *blockchain*
  (t/ref (list
          (block 0 (string->bytes/utf-8 "0") 1509658251 "genesis block" (calculate-hash 0 (string->bytes/utf-8 "0") 1598658251 "genesis-block")))))
